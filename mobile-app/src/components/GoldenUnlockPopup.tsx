...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    // Fixed merge-order bug: ...Shadow.card was spread AFTER the explicit
    // gold shadow values, silently overwriting them with Shadow.card's
    // generic black shadowColor/opacity/radius — the intended gold glow
    // never actually rendered. Spread first, override after.
    ...Shadow.card,
