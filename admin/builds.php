...
$dir  = '/var/www/setalink/public/download/smart-mode-b75';
$base = 'https://setalink.no/download/smart-mode-b75';
$files = [
  ['setalink-smartmode-b75-arm64.apk',     'arm64-v8a (most modern phones)'],
  ['setalink-smartmode-b75-universal.apk', 'Universal (any device / fallback)'],
];
$sums = [];
...
<h1>📦 Test Builds — Smart Mode / Iran Bypass</h1>
<div class="card warn">
  ...
  <p class="muted" style="margin:.4rem 0 0">
    ...
    iOS build 75 is on TestFlight; this is its Android counterpart from the same
    <code>release/build75-smart-mode</code> branch (Android versionName 0.9.49 / versionCode 65 —
    the gradle version was not bumped, so it differs from stable only by the Smart Mode feature).
  </p>
</div>
<div class="card">
