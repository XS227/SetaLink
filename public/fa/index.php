...
$desc      = 'ری‌لینک: فیلترشکن هوشمند مبتنی بر هوش مصنوعی با پروتکل VLESS+Reality. ۵ گیگابایت رایگان بدون ثبت‌نام. بایپس DPI. اندروید.';
...
<script type="application/ld+json">
{
  ...
  "description": "فیلترشکن هوشمند با پروتکل VLESS+Reality برای ایران. ۵ گیگابایت رایگان بدون ثبت‌نام.",
...
<section class="hero">
  ...
  <p class="hero-sub">
    فیلترشکن مبتنی بر هوش مصنوعی، ساخته‌شده برای سانسور واقعی. اندروید و آیفون (iOS). ۵ گیگابایت رایگان پس از نصب. بدون حساب. بدون تنظیمات.
  </p>
...
<section class="section" id="how">
  ...
  <div class="steps-bento">
    <div class="step-card" style="text-align:right">
      ...
      <p>APK را نصب کن و فوری ۵ گیگابایت بگیر — بدون لاگین، بدون حساب. Connect را بزن و هوش مصنوعی سریع‌ترین پروتکل را انتخاب می‌کند.</p>
    </div>
    <div class="step-card" style="text-align:right">
...
<section class="section" id="faq">
  ...
  <div class="faq-list" style="text-align:right">
    ...
    $faqs_fa = [
      ...
      ['بسته ۵ گیگابایت اضطراری چیست؟',
       'هر دستگاه جدیدی که ری‌لینک را نصب کند، به طور خودکار ۵ گیگابایت داده رایگان دریافت می‌کند — بدون حساب، بدون لاگین، بدون کارت اعتباری. طراحی شده برای اینکه هر کسی که ناگهان به اینترنت دسترسی ندارد، بتواند فوری به اینترنت آزاد برگردد.'],
