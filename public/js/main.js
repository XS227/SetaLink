(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'how.s1.p':  'Install the app and get 1 GB instantly — no login, no account. Tap Connect and the AI selects the fastest working protocol for your network.',
    ...
    zh: {
      ...
      'how.s1.h':  '紧急接入',
      'how.s1.p':  '安装应用立即获得 1 GB — 无需登录，无需账号。点击连接，AI 会为你的网络选出最快可用的协议。',
      'how.s2.h':  '邀请好友，赚取流量',
    ...
    ru: {
      ...
      'how.s1.p':  'Установите приложение и сразу получите 1 ГБ — без входа и аккаунта. Нажмите «Подключить», и ИИ выберет самый быстрый рабочий протокол для вашей сети.',
      ...
      'pricing.sub':   '1 ГБ при установке, больше — за приглашения, тариф с безлимитом скоро.',
      ...
      'plan.free.f1':      'Стартовая квота 1 ГБ',
