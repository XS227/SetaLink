(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'hero.badge': 'Server Online &mdash; secure global nodes',
    ...
    fa: {
      ...
      'hero.badge': 'سرور فعال &mdash; گره‌های امن جهانی',
      ...
      'why.sub':        'یک پوشش VPN عمومی نیست. از صفر برای واقعیت سانسور اینترنت در ایران ساخته شده.',
