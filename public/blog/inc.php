...
$BLOG_ARTICLES = [
  ...
  'starlink-iran' => [
    'title' => 'استارلینک در ایران: قانونی است؟ چطور کار می‌کند و چطور استفاده کنیم (۱۴۰۵)',
    'h1'    => 'استفاده از استارلینک در ایران — راهنمای کامل',
    'desc'  => 'استارلینک در ایران طبق مجوز عمومی D-2 وزارت خزانه‌داری آمریکا قانونی است. این راهنما توضیح می‌دهد استارلینک چیست، چرا فیلترینگ داخلی روی آن اثر ندارد، محدودیت‌های واقعی امروز، و اینکه ری‌لینک/رئال‌گرام چطور از آن به‌عنوان یک مسیر ارتباطی استفاده می‌کند.',
    'keywords' => 'استارلینک ایران, استفاده از استارلینک در ایران, اینترنت ماهواره‌ای ایران, استارلینک قانونی است, وی‌پی‌ان استارلینک, Starlink Iran',
    'date'  => '2026-07-22',
    'excerpt' => 'استارلینک برای ایران قانونی است، اما استفاده عملی از آن چالش‌های خودش را دارد. اینجا توضیح می‌دهیم چطور کار می‌کند و ری‌لینک/رئال‌گرام چطور از آن استفاده می‌کند.',
    'faq' => [
      ['q' => 'آیا استفاده از استارلینک در ایران قانونی است؟',
       'a' => 'طبق «مجوز عمومی D-2» وزارت خزانه‌داری آمریکا (OFAC) که در ژانویه ۲۰۲۳ صادر شد، ارائه خدمات اینترنت ماهواره‌ای مثل استارلینک به کاربران ایرانی به‌صراحت مجاز شمرده شده — این مجوز دقیقاً برای پشتیبانی از دسترسی آزاد به اینترنت صادر شده است. وضعیت مالکیت و نصب فیزیکی دیش داخل خاک ایران از نظر قوانین داخلی ایران موضوع جداگانه‌ای است و باید مستقل از این بررسی شود.'],
      ['q' => 'چرا فیلترینگ داخلی ایران نمی‌تواند استارلینک را مسدود کند؟',
       'a' => 'چون سیگنال مستقیم بین دیش و ماهواره رد و بدل می‌شود و هرگز از زیرساخت اپراتورهای داخلی (ایرانسل، همراه‌اول، مخابرات) عبور نمی‌کند — همان جایی که فیلترینگ و بازرسی عمیق بسته (DPI) اعمال می‌شود.'],
      ['q' => 'آیا برای استفاده از استارلینک در ایران حتماً باید دیش فیزیکی داشته باشم؟',
       'a' => 'برای اتصال مستقیم دیش-به-ماهواره، بله. اما یک راه دیگر هم هست: وصل‌شدن به گیت‌وی‌ای که خودش از طریق استارلینک به اینترنت وصل است — دقیقاً همان چیزی که ری‌لینک/رئال‌گرام الان می‌سازد، بدون نیاز کاربر نهایی به خرید و نصب دیش.'],
      ['q' => 'آیا مسیر استارلینک ری‌لینک همین الان در دسترس همه است؟',
       'a' => 'نه هنوز. الان یک گره فعال و دسترسی دعوت‌محور است — مرحله اولیه. اولین تستر ایرانی ما یک هفته است رویش کار می‌کند و می‌گوید نسبت به هر اپ دیگری که در ایران امتحان کرده، سریع‌تر و پایدارتر است. ظرفیت به‌مرور که پایداری‌اش تأیید شود گسترش پیدا می‌کند.'],
    ],
  ],
